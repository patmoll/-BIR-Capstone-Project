...
library("xlsx") #install.packages("xlsx", dependencies = TRUE)
...
zscore_purchases <- function(agg_purch, taxyear, taxqtr, ind_med_purch, ind_mad_purch) {
  ...
  ###getting the z-scores of purch in relation to personal company's history 
...
###################################################################
## SEC Fraud + Unlabeled 2 Training, Unlabeled 3 as validation
...
########################################################
### BIR Fraud + unlabeled 2 as training, cross
...
#########################################################
### BIR Fraud + unlabeled 2 as training, with SEC Fraud as validation
...
#########################################################
### BIR Fraud + unlabeled 2 as training, with unlabeled 3 as validation
...
###SEC fraud + unlabeled 3 as training, and cross validation ########
...
#######################################################
### SEC fraud, + unlabeled 3 as training, BIR Fraud as Validation ####
...
###################################################################
## SEC Fraud + Unlabeled 3 Training, Unlabeled 2 as validation
...
###BIR fraud + unlabeled 3 as training, and cross validation ########
...
#######################################################
### BIR fraud, + unlabeled 3 as training, SEC Fraud as Validation ####
...
###################################################################
## BIR Fraud + Unlabeled 3 Training, Unlabeled 2 as validation
